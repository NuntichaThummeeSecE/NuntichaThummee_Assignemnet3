...
const QUESTIONS = [
    ...
    },
    {
        ...
        choices: ["A stolen necklace","A priceless painting", "A will", "A hotel key"],
        answer: 1,
    },
    {
        question: "Which fictional country is the Grand Budapest Hotel located in?",
        choices: ["Eldoria", "Frolinia", "Valoria", "Zubrowka"],
        answer: 3,
    },
    {
        question: "What type of establishment is the Grand Budapest Hotel?",
        choices: ["A restaurant", "A museum", "A hotel", "A casino"],
        answer: 2,
    },
]